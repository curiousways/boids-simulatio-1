...
function createBoids() {
  ...
  for (i = 0; i < numBoids; i++) {
    ...
    var radiusCoefficient = Math.floor(
      Math.random() * radiusCoefficients.length
    );
    ...
    if (i !== 0) {
      for (var j = 0; j < boids.length; j++) {
        if (
          getDistance(x, y, boids[j].x, boids[j].y) -
            (radius + boids[j].radius) <
          0
        ) {
...
// // Introversion
// var introversionControlContainer = document.getElementById(
//   "introversion-control-container"
// );
...
// // Racism
// var racismControlContainer = document.getElementById(
//   "racism-control-container"
// );
...
// // Diversity
// var diversityControlContainer = document.getElementById(
//   "diversity-control-container"
// );
